...
class SummarizeDocumentInput(BaseModel):
    ...
    text: str = Field(
        ...,
        description="The large document text to chunk, retrieve from, and summarize.",
    )
    query: str = Field(
        ..., description="The query to search for within the document to summarize."
    )
...
class SaveMemoryInput(BaseModel):
    ...
    fact: str = Field(
        ...,
        description="The user fact to save into long-term memory (e.g., 'User loves Python').",
    )
...
class SearchMemoryInput(BaseModel):
    ...
    query: str = Field(
        ...,
        description="The query to search the long-term memory (e.g., 'What are the user's hobbies?').",
    )
